...
- [ ] T066 [P] [US1] Version the unchanged Feature 003 three-file Codex package and update both marketplace identity and `distribution/codex-marketplace/release-integrity.json` in `integrations/codex/skillwire-autonomous-activation/.codex-plugin/plugin.json`, `distribution/codex-marketplace/marketplace.json`, and `distribution/codex-marketplace/release-integrity.json`
