...
- **SC-014**: In the same fixed ten-participant moderated cohort, at least 9/10 complete the journey and identify installation state and the next safe recovery action from final setup or doctor output without moderator intervention or consulting service internals. A location-only clarification of already visible frozen documentation is recorded separately and supplies no procedural guidance.
